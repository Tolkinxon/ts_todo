...
const writeFile = (fileName, users) => __awaiter(void 0, void 0, void 0, function* () {
    yield promises_1.default.writeFile(dbFilePath(fileName), JSON.stringify(users, null, 4));
    return true;
});
